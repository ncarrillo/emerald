...
impl Spg {
    ...
    pub fn on_scheduled_event(
        ...
        match event_data {
            SpgEventData::VBlankIn => {
                ...
                scheduler.schedule(crate::scheduler::ScheduledEvent::HollyEvent {
                    deadline: 0,
                    event_data: HollyEventData::RaiseInterruptNormal { istnrm: 0.set_bit(3) },
                });
            ...
            SpgEventData::HBlank => {
                ...
                scheduler.schedule(crate::scheduler::ScheduledEvent::HollyEvent {
                    deadline: 0,
                    event_data: HollyEventData::RaiseInterruptNormal { istnrm: 0.set_bit(5) },
                });
            }
            SpgEventData::VBlankOut => {
                ...
                scheduler.schedule(crate::scheduler::ScheduledEvent::HollyEvent {
                    deadline: 0,
                    event_data: HollyEventData::RaiseInterruptNormal { istnrm: 0.set_bit(4) },
                });
            }
        }
    }
    ...
    pub fn recalc_freq(&mut self) -> (u64, u64, u64) {
        ...
        let vblank_out_freq = (((self.registers.vblank & 0x3ff0000) >> 16) as u64 * cycles_per_scanline) as u64;
